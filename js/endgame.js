...
const rsc_string = {
    ...
    jumpTo2012: "[2012] The center stage in this three ring circus: Stark, Steve, Scott, and Bruce travel to the attack on New York to retrieve 3 infinity stones. Let's see how that turns out.",
    lokiFucksOff: "Oh shit where did Loki go?",
    jumpTo2013: "[2013] Thor and Rocket head to Asgard circa Thor: The Dark World to retrieve the reality stone.",
    jumpTo2014: "[2014] Rhodey and Nebula go to Morag circa Guardians of the Galaxy to retrieve the power stone. ScarJo and Hawkeye go with them, but head to Vormir to get the Soul Stone",
    jumpTo1970: "[1970] In a bold act of improvising that would make Ryan Stiles proud, Steve and Tony go to a military base in 1970 to retrieve another Tesseract and some Pym particles",
    returnFrom2012: "[2023] Bruce and Scott return to the present, time stone and mind stone in hand.",
    returnFrom2013: "[2023] Thor and Rocket return to the present with the reality stone and a souvenir.",
    returnFrom2014_SoulStone: "[2014] After Clint brutally murders his lifetime co-worker, he acquires the soul stone and returns to the present",
    returnFrom2014_PowerStone: "[2023] Rhodey returns with the power stone, but Nebula is kidnapped, though Rhodey is unaware of this.",
    returnFrom1970: "[2023] Cap and Stark each encounter old friends, and return to the present",
    returnFrom2014_Nebula: "[2023] The 2014 Nebula disguises herself as the 2023 Nebula and goes to the future/present (depending on your point of view)",
    thanosToPresent: "[2023] Nebula hacks into ... something, and summons Thanos and his army into the future where we prepare for act 3",
    starkStones: "[2023] Stark manages to acquire the stones and snaps Thanos into oblivion. Also Cap picks up Mjolnir",
    capStones: "[2023] Cap collects all the stones and Mjolnir. After jumping between alternate realities (plothole) without creating new branched realities (plothole), catching up with redskull, and replacing all the stones in their original forms (plothole), he finally returned to Peggy for that dance.",
